...
using Lendme.Application.Chat.Commands.Create;
using Lendme.Application.Chat.Commands.Update;
using Lendme.Application.Chat.Dto.Request;
using Lendme.Application.Chat.Dto.Response;
using Lendme.Application.Chat.Queries;
        ...
        [FromBody] SendMessageRequest request)
    {
        try
        {
            var command = new SendMessageCommand
            {
                ...
                Type = request.Type,
                //Attachments = request.Attachments ?? new List<ChatMessageAttachment>()
            };
